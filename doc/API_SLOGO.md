...
1. What is the result of parsing and who receives it?
    * The result of parsing is a set of commands that are able       to be understood by our frontend.Turtle class. For example, if the
...
---
# CLASSES
frontend.ModelController View frontend.Controller
