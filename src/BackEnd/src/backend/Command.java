...
//        public String backward (backend.Turtle t, String distance){
//                Double d = Double.parseDouble(distance);
//                t.move(-d);
//                return distance;
//            }
//
//            public String left (backend.Turtle t, String degree){
//                Double d = Double.parseDouble(degree);
//                t.turn(d);
//                return degree;
//            }
//
//            public String right (backend.Turtle t, String degree){
//                Double d = Double.parseDouble(degree);
//                t.turn(-d);
//                return degree;
//            }
//
//            public String setHeading (backend.Turtle t, String degree){
//                Double d = Double.parseDouble(degree);
//                t.setHeading(d);
//                return degree;
//            }
//
//            public String setTowards (backend.Turtle t, String arguments){
...
//                return d;
//            }
//            public String penUp (backend.Turtle t){
//                t.liftPenUp();
//                return "0";
//            }
//
//            public String showTurtle (backend.Turtle t){
//                t.show();
//                return "1";
//            }
//
//            public String hideTurtle (backend.Turtle t){
//                t.hide();
//                return "0";
//            }
//
//            public String home (backend.Turtle t){
//                double dist = calcDist(t.getX(), t.getY(), 0, 0);
//                t.setPosition(0, 0);
//                return ((Double) dist).toString();
//            }
//
//    public String clearScreen(backend.Turtle t, backend.ModelController m){
//        m.clearScreen();
//        return this.home(t);
//    }
//
...
//    }
//
//    public String setPosition(backend.Turtle t, String arguments){
//        String[] position = arguments.split(" ");
...
//    }
//
//    public String penDown(backend.Turtle t){
//        t.putPenDown();
//        return "1";
//    }
//
...
//    }
//
////    public String clearScreen(backend.Turtle t, Model m){
////        m.clearScreen();
////        return this.home(t);
////    }
//
//    public String xCoordinate(backend.Turtle t){
//        return ((Double) t.getX()).toString();
//    }
//
//    public String yCoordinate(backend.Turtle t){
//        return ((Double) t.getY()).toString();
//    }
//
//    public String heading(backend.Turtle t){
//        return ((Double) t.getDirection()).toString();
//    }
//
//    public String isPenDown(backend.Turtle t){
//        return t.getIsPenDown() ? "1":"0";
//    }
//
//    public String isShowing(backend.Turtle t){
...
//    }
//
//    public String setPenColor(backend.Turtle t, String arguments){
//
//    }
//
//    public String setPenSize(backend.Turtle t, String arguments){
//
//    }
//
...
//    }
//
//    public String getPenColor(backend.Turtle t, String arguments){
//
//    }
//
...
//        System.out.println(backend.Command.angleWithXAxis(1.0, 1.0));
//    }
