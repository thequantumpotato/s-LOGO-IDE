...
/**
 * An aggregate of all the backend.Nodes that will be displayed.
 *
 * @author Vincent Liu
 */
...
public class View {
    ...
    public void printTurtlePos(Coordinate newCoordinate) {
        System.out.print("X: " + newCoordinate.getX() + "Y: " + newCoordinate.getY() + "Angle: " + newCoordinate.getAngle());
    }
}
